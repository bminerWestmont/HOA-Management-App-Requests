...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">  
    <img src="./media/logo.jpg" width="30" height="30" alt=""> <!-- What is this image trying to point to? this url does not exist in this directory... -->
  </a></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="./index.php">CONTACT</a>
