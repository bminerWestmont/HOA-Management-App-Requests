...
<div class="jumbotron jumbotron-fluid ">
    <div class="container">
        <h1 class="display-4">Your Changes have been updated.</h1>
        <p> Ticket Number: 33467 </p>
        <h1>If you would like to update the Homeowner of these changes, click the button below.  </h1>

    </div>
</div>

<<div class="row">
        <a  href="./updateHomeowner.php" class="col-sm btn btn-lg secondaryColor">Update Homeowner</a> </div>
